 ...
 * ------------------------------------------------------------------------- */
static constexpr uint16_t VVBLKI_RET = 0xE45Fu;  /* JMP here at end of immediate VBlank handler */
static constexpr uint16_t VVBLKD_RET = 0xE462u;  /* JMP here at end of deferred VBlank handler */
 ...
 * Note: These depend on CHR_SET2 runtime value, kept as macros for compatibility
 * ------------------------------------------------------------------------- */
...
static constexpr uint8_t CHR_MISS_LEFT  = 0x71u; /* MISS.LEFT missile character */
static constexpr uint8_t CHR_MISS_RIGHT = 0x72u; /* MISS.RIGHT missile character */
